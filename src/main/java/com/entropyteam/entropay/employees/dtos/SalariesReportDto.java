...
public record SalariesReportDto(UUID id, UUID employeeId, String internalId, String firstName, String lastName,
                                String clientName, @SensitiveInformation BigDecimal salary,
                                @SensitiveInformation BigDecimal rate, String modality, String currency,
                                String platform, String country) implements EmployeeIdAware {
