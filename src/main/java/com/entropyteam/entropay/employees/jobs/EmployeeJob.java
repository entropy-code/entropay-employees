...
public class EmployeeJob {
    ...
    private final com.entropyteam.entropay.employees.services.EmployeeService employeeService;
    private final GoogleService googleService;

    @Autowired
    public EmployeeJob(EmployeeRepository employeeRepository, com.entropyteam.entropay.employees.services.EmployeeService employeeService, GoogleService googleService) {
