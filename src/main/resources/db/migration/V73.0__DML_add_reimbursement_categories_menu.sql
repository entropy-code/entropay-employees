-- Add reimbursement-categories permissions for ROLE_ADMIN
...
-- Add reimbursement-categories permissions for ROLE_MANAGER_HR
UPDATE public.config SET permissions = e'[
...
-- Update menu for ROLE_ADMIN (add reimbursement-categories to Settings submenu)
...
-- Update menu for ROLE_MANAGER_HR (add reimbursement-categories to Settings submenu)
UPDATE public.config SET menu = e'[
  {
    "name": "Employees",
    "href": "/#/employees",
