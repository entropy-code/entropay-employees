...
-- Create contract_benefit relationship table
CREATE TABLE IF NOT EXISTS contract_benefit (
    contract_id UUID NOT NULL,
    benefit_id UUID NOT NULL,
    PRIMARY KEY (contract_id, benefit_id),
    CONSTRAINT fk_contract_benefit_contract FOREIGN KEY (contract_id) REFERENCES contract(id),
    CONSTRAINT fk_contract_benefit_benefit FOREIGN KEY (benefit_id) REFERENCES benefit(id)
);

-- Create indexes for better performance
CREATE INDEX IF NOT EXISTS idx_benefit_deleted ON benefit(deleted);
CREATE INDEX IF NOT EXISTS idx_contract_benefit_contract_id ON contract_benefit(contract_id);
CREATE INDEX IF NOT EXISTS idx_contract_benefit_benefit_id ON contract_benefit(benefit_id);

-- Add benefits permissions for ROLE_ADMIN
...
-- Add benefits permissions for ROLE_MANAGER_HR
UPDATE public.config SET permissions = e'[
...
-- Update menu for ROLE_ADMIN (add benefits to Settings submenu)
...
-- Update menu for ROLE_MANAGER_HR (add benefits to Settings submenu)
UPDATE public.config SET menu = e'[
  {
    "name": "Employees",
    "href": "/#/employees",
